...
--changeset admin:002:create-products-table context:ddl
...
--changeset admin:003:add-indexes context:ddl
CREATE INDEX idx_users_email ON users(email);
CREATE INDEX idx_products_name ON products(name);
--rollback DROP INDEX idx_users_email; DROP INDEX idx_products_name;

--changeset admin:004:add-categories-table context:ddl
...
--changeset admin:005:add-category-id-to-products context:ddl
ALTER TABLE products ADD COLUMN category_id INTEGER REFERENCES categories(id);
--rollback ALTER TABLE products DROP COLUMN category_id;

--changeset admin:006:create-orders-table context:ddl
CREATE TABLE orders (
    id SERIAL PRIMARY KEY,
...
--changeset admin:007:create-order-items-table context:ddl
...
--changeset admin:008:add-constraints context:ddl
...
--changeset admin:009:create-views context:ddl
...
--changeset admin:010:add-comments context:ddl
...
--rollback COMMENT ON TABLE users IS NULL; COMMENT ON TABLE products IS NULL; COMMENT ON TABLE categories IS NULL; COMMENT ON TABLE orders IS NULL; COMMENT ON TABLE order_items IS NULL;

--changeset admin:011:insert-sample-categories context:dml
...
--changeset admin:012:insert-sample-products context:dml
...
--changeset admin:013:insert-sample-users context:dml
